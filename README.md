...
> **R:**
Porque incluye el contenido de las librerias.
---
...
> **R:**
Porque los comentarios desaparecen al ejecutar el codigo.
---
...
> **R:**
Proviene de la libreria stdio.h
---
...
> **R:**
Por que en matematica lo define y en el programa lo usa
...
> **R:**
Porque estan en las bibliotecas y se resuelven cuando se ejecuta el programa
---
...
> **R:**
La macro funcion desaparece en el preprocesamiento mientras que la funcion cuando termina el programa y ademas esta ultima tiene verificacion de tipos.
---
...
> **R:**
El tipo T es texto en el .text y el tipo D son datos inicializados en .data
---
...
> **R:**
        ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7ff8cabe0000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x77c00000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7ff8ca0c0000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7ff8ca8e0000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7ff8c8a90000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7ff8c93a0000)
¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:**
porque gcc lo hace automaticamente.
---
...
//agrego comentario para que se cambie el nombre del archivo al pushear